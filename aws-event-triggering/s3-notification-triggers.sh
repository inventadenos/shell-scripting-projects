...
bucket_name="ufuoma-lambda-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="ufuoma.eleovie@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Ufuoma.EleOvie YouTube channel, Learn DevOps Zero to Hero for Free"
